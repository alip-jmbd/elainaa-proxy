...
<h1 align="center">✨ @elainaa/proxy ✨</h1>
...
#### 2. Client Factory (`createGatePass`)
...
#### 3. Smart Auto Mode (`gatepass.auto`)
...
try {
  ...
  const html = await gatepass.auto('https:example.com', options);
  console.log('✅ Success!');
} catch (error) {
